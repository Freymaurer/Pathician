...
let project = "PathfinderAttackSimulator"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "An automatic calculator for both standard and full round attack actions, based on a library of modifications, weapons and characters."

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "An automatic calculator for both standard and full round attack actions, based on a library of modifications, weapons and characters."

// List of author names (for NuGet package)
let author = "Kevin Frey"

// Tags for your project (for NuGet package)
let tags = "pathfinder f# fsharp attack simulator calculator"

// File system information
let solutionFile  = "PathfinderAttackSimulator.sln"
...
let gitName = "PathfinderAttackSimulator"

// The url for the raw files hosted
let gitRaw = Environment.environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/Freymaurer"

let website = "/PathfinderAttackSimulator"
...
let info =
  [ "project-name", "PathfinderAttackSimulator"
    "project-author", "Kevin Frey"
    "project-summary", "An automatic calculator for both standard and full round attack actions, based on a library of modifications, weapons and characters."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/PathfinderAttackSimulator" ]
